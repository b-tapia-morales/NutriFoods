...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<Nutrient, NutrientDto>()
            .ForMember(dest => Essentiality.FromName(dest.Essentiality, false),
        ...
        CreateMap<IngredientNutrient, IngredientNutrientDto>().ForMember(dest => Unit.FromName(dest.Unit, false),

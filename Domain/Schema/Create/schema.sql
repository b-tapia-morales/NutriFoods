DROP TABLE IF EXISTS nutrifoods.menu_recipe;
...
DROP TABLE IF EXISTS nutrifoods.user_metric;
...
(
    id                   SERIAL,
    user_id              INTEGER          NOT NULL,
    meals_daily_amount   INTEGER          NOT NULL,
...
(
    ...
    alcohol_total       DOUBLE PRECISION NOT NULL,
...
(
    ...
    FOREIGN KEY (recipe_id) REFERENCES recipe (id),
    PRIMARY KEY (meal_menu_id, recipe_id)
);
...
VALUES ('Sal', false, false, 23),
       ...
       ('Diente de dragón', false, false, 7),
       ('Champiñón París', false, false, 7),
       ('Ron', false, false, 25),
       ...
       ('Esencia de cola mono', false, false, 25),
       ...
       ('Locos', true, false, 11),
       ('Laminas de lasaña', false, true, 9),
       ('Trutos de pollo', true, false, 12),
       ...
       ('Choros de zapato', true, false, 11),
